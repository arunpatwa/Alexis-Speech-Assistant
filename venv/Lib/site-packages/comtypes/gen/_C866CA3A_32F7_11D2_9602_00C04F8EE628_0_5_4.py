...
__all__ = [
    'SAFTGSM610_8kHzMono', 'SpeechTokenKeyFiles', 'SPWT_LEXICAL',
    'SRADefaultToActive', 'SP_VISEME_17', 'SPSHORTCUTPAIR',
    'DISPID_SpeechMemoryStream', 'DISPID_SPPFirstElement',
    'SSFMOpenForRead', 'STCRemoteServer', 'Speech_Max_Pron_Length',
    'eLEXTYPE_RESERVED7', 'ISpeechPhraseRules',
    'ISpeechAudioBufferInfo', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SAStatus', 'SPPHRASEELEMENT', 'SPSHT_Unknown',
    'SPVPRIORITY', 'SVP_17', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SVSLastBookmarkId', 'SPCONTEXTSTATE', 'SpeechDiscardType',
    'DISPID_SVEPhoneme', 'SINone', 'DISPID_SRGState',
    'DISPID_SWFEExtraData', 'SP_VISEME_8', 'SPPHRASEPROPERTY',
    'SVEVoiceChange', 'SGLexical', 'SPPS_Verb', 'SPSMF_UPS',
    'eLEXTYPE_RESERVED6', 'DISPID_SpeechPhraseInfo', 'SPBO_AHEAD',
    'SpPhoneticAlphabetConverter', 'SPWORD',
    'SpeechGrammarTagDictation', 'SPVPRI_OVER', 'SPEI_VISEME',
    'DISPID_SVEAudioLevel', 'DISPID_SOTCGetDataKey',
    'DISPID_SDKGetBinaryValue', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SOTRemove', 'ISpeechLexiconWords', 'SRAInterpreter',
    'SPLO_STATIC', 'DISPID_SOTGetStorageFileName', 'ISpRecoContext',
    'DISPID_SpeechLexiconWord', 'SpeechLoadOption',
    'SAFTCCITT_ALaw_11kHzStereo', 'SVSFNLPMask', 'ISpEventSource',
    'SVEEndInputStream', 'SpeechAudioFormatGUIDText',
    'DISPID_SRCRetainedAudio', 'DISPIDSPRG',
    'DISPID_SRGCmdLoadFromResource', 'ISpeechRecoContext',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SDKEnumKeys',
    'SITooLoud', 'DISPID_SGRSTPropertyValue', 'SPSHT_EMAIL',
    'SP_VISEME_15', 'DISPID_SPCLangId', 'SPEI_SR_AUDIO_LEVEL',
    'SAFTADPCM_44kHzMono', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SpeechPhoneConverter',
    'Speech_Max_Word_Length', 'SP_VISEME_12', 'SVPNormal',
    'DISPID_SVSInputWordPosition', 'DISPID_SVSpeak',
    'eLEXTYPE_PRIVATE16', 'DISPID_SRCEAudioLevel',
    'DISPID_SPANumberOfElementsInResult', 'eLEXTYPE_PRIVATE19',
    'ISpeechFileStream', 'DISPID_SpeechVoiceEvent',
    'SPEI_PHRASE_START', 'STSF_AppData', 'SPVPRI_NORMAL',
    'DISPID_SGRSTsCount', 'SDKLCurrentUser', 'SPAS_CLOSED', 'SVP_3',
    'SAFT11kHz16BitStereo', 'SBONone', 'SRERequestUI',
    'DISPID_SAVolume', 'DISPID_SDKCreateKey',
    'DISPID_SRCVoicePurgeEvent', 'SAFTADPCM_8kHzMono',
    'DISPID_SMSGetData', 'ISpNotifySink',
    'DISPID_SpeechXMLRecoResult', 'ISpeechGrammarRuleState',
    'SPEI_VOICE_CHANGE', 'SREAllEvents', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SPCIdToPhone',
    'SP_VISEME_16', 'SAFT32kHz8BitStereo', 'SpeechRuleAttributes',
    'DISPID_SPRFirstElement', 'DISPID_SASFreeBufferSpace',
    'SWPUnknownWordPronounceable', 'DISPID_SGRsDynamic',
    'DISPID_SPEsItem', 'SPPS_Function', 'SP_VISEME_2',
    'SPEI_INTERFERENCE', 'SP_VISEME_21', 'SPVISEMES',
    'SpeechUserTraining', 'SpCustomStream', 'SVPAlert',
    'SPEI_SR_PRIVATE', 'SRERecoOtherContext', 'ISpeechAudio',
    'ISpeechPhraseAlternates', 'ISpPhraseAlt', 'DISPID_SPRuleId',
    'DISPID_SLPsCount', 'DISPID_SPEAudioSizeBytes', 'SVF_Emphasis',
    'SREInterference', 'SPAO_NONE', 'DISPID_SpeechRecoResult2',
    'SPSERIALIZEDPHRASE', 'SpeechRetainedAudioOptions',
    'DISPID_SPEAudioSizeTime', 'SITooFast', 'SPINTERFERENCE_NONE',
    'SSTTTextBuffer', 'SPPS_SuppressWord', 'SSFMCreate',
    'SPEI_RESERVED3', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SGRSTWeight', 'SPFM_OPEN_READWRITE',
    'DISPID_SRSClsidEngine', 'SpeechAllElements',
    '_ISpeechVoiceEvents', 'SpeechRuleState', 'SP_VISEME_1',
    'DISPID_SPRText', 'SREStreamEnd', 'SPWORDLIST',
    'SECLowConfidence', 'SDA_One_Trailing_Space',
    'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SpeechPhraseProperties', 'DISPID_SASNonBlockingIO',
    'SAFTCCITT_ALaw_22kHzMono', 'SREPhraseStart',
    'SPSHORTCUTPAIRLIST', 'ISpeechLexiconWord', 'SVSFParseAutodetect',
    'SPEI_END_SR_STREAM', 'DISPID_SVSLastBookmark',
    'DISPID_SRCEBookmark', 'DISPID_SpeechPhraseRules', 'SVP_18',
    'SAFT12kHz8BitMono', 'DISPID_SLWPronunciations',
    'ISpeechPhraseProperties', '_RemotableHandle',
    'DISPID_SAEventHandle', 'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SGRSTsItem', 'DISPID_SRGetPropertyNumber',
    'DISPID_SRGCmdSetRuleIdState', 'ISpeechPhoneConverter',
    'eLEXTYPE_PRIVATE9', 'SPXRO_Alternates_SML',
    'SpeechRecoContextState', 'IStream', 'DISPID_SLWs_NewEnum',
    'SWPUnknownWordUnpronounceable', 'SpeechVisemeType',
    'SPAR_Unknown', 'DISPID_SpeechVoiceStatus', 'SpMMAudioEnum',
    'SPDATAKEYLOCATION', 'SPVPRI_ALERT', 'ISpLexicon',
    'DISPID_SGRAddState', 'SECFNoSpecialChars',
    'SGLexicalNoSpecialChars', 'SVSFParseSsml',
    'DISPID_SVAlertBoundary', 'eLEXTYPE_PRIVATE4', 'ISpeechVoice',
    'DISPID_SOTDataKey', 'SPVOICESTATUS',
    'DISPID_SPPEngineConfidence', 'SVF_None', 'eLEXTYPE_PRIVATE3',
    'DISPID_SPPId', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SRRSetTextFeedback', 'SVEAllEvents',
    'DISPID_SPEs_NewEnum', 'eLEXTYPE_PRIVATE8',
    'SPEI_PROPERTY_NUM_CHANGE', 'ISpeechPhraseInfo',
    'DISPID_SGRSTType', 'DISPID_SPPsItem',
    'Speech_StreamPos_RealTime', 'ISpVoice', 'SPSLMA', 'UINT_PTR',
    'DISPID_SRDisplayUI', 'SECHighConfidence', 'SPWORDTYPE',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SRState',
    'DISPID_SABIEventBias', 'DISPID_SGRClear',
    'SDA_Consume_Leading_Spaces', 'SAFTCCITT_uLaw_8kHzStereo',
    'SP_VISEME_7', 'IEnumSpObjectTokens', 'SSTTWildcard',
    'SpeechEngineConfidence', 'SPWAVEFORMATTYPE', 'SpFileStream',
    'DISPID_SRCEventInterests', 'ISpeechRecoResultTimes',
    'DISPID_SRCAudioInInterferenceStatus', 'SpeechEngineProperties',
    'SREPropertyNumChange', 'SpeechTokenValueCLSID',
    'DISPID_SVSVisemeId', 'SPEI_PHONEME', 'SPEI_HYPOTHESIS',
    'SVEBookmark', 'SSSPTRelativeToEnd', 'SpShortcut',
    'DISPID_SpeechAudio', 'DISPID_SVEStreamStart',
    'DISPID_SpeechLexicon', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SVRate', 'SpeechTokenIdUserLexicon', 'DISPID_SRRTimes',
    'IInternetSecurityMgrSite', 'DISPID_SRRGetXMLResult',
    'SVEWordBoundary', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SFSClose', 'SVSFIsFilename', 'SpeechDisplayAttributes',
    'DISPID_SRStatus', 'SAFT12kHz16BitMono', 'DISPID_SVAudioOutput',
    'eLEXTYPE_PRIVATE6', 'SAFTADPCM_22kHzMono', 'DISPID_SGRsFindRule',
    'DISPID_SPERetainedStreamOffset', 'eLEXTYPE_PRIVATE13',
    'DISPID_SLAddPronunciationByPhoneIds', 'SPPS_RESERVED3',
    'SPSTREAMFORMATTYPE', 'DISPID_SRSetPropertyString',
    'SPINTERFERENCE_LATENCY_WARNING', 'SpNotifyTranslator',
    'SpeechRegistryUserRoot', 'SITooQuiet',
    'DISPID_SVSpeakCompleteEvent', 'eWORDTYPE_DELETED', 'SVP_4',
    'DISPID_SGRsCommitAndSave', 'SREPropertyStringChange',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SSFMOpenReadWrite',
    'WAVEFORMATEX', 'DISPID_SPISaveToMemory', 'SPCT_SUB_COMMAND',
    'SPRECORESULTTIMES', 'STCLocalServer', 'ISpRecoResult',
    'SFTInput', 'DISPID_SpeechAudioBufferInfo', 'DISPID_SVPriority',
    'DISPID_SpeechObjectToken', 'SASClosed', 'DISPID_SOTCDefault',
    'DISPID_SDKSetStringValue', 'SPFM_CREATE', 'SP_VISEME_0',
    'eLEXTYPE_LETTERTOSOUND', 'SAFT32kHz8BitMono',
    'SAFT44kHz16BitMono', 'SpeechAudioFormatGUIDWave', 'SPRST_ACTIVE',
    'SPSMF_SAPI_PROPERTIES', 'SPDKL_CurrentUser', 'SPEI_TTS_PRIVATE',
    'SPEI_MIN_TTS', 'DISPID_SDKGetStringValue',
    'DISPID_SVSyncronousSpeakTimeout', 'SAFT8kHz8BitMono',
    'DISPID_SMSAMMHandle', 'DISPID_SRRPhraseInfo',
    'DISPID_SpeechGrammarRules', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SLWWord', '__MIDL_IWinTypes_0009', 'SPWT_PRONUNCIATION',
    'DISPID_SRGCommit', 'SPSVerb', 'SP_VISEME_18',
    'SpeechCategoryVoices', 'SPWORDPRONUNCIATION', 'SPRS_ACTIVE',
    'SWTDeleted', 'DISPID_SVEEnginePrivate', 'SVP_10',
    'ISpeechXMLRecoResult', 'ISpeechObjectToken', 'SP_VISEME_14',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SPIStartTime',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SPIGetDisplayAttributes',
    'SVP_16', 'eLEXTYPE_PRIVATE14', 'DISPID_SRRSaveToMemory',
    'SPCT_SLEEP', 'SPRULE', 'STSF_FlagCreate',
    'DISPID_SPEActualConfidence', 'SPCT_COMMAND',
    'DISPID_SASCurrentDevicePosition', 'SAFT16kHz16BitStereo',
    'SVSFlagsAsync', 'SPSERIALIZEDRESULT', 'eLEXTYPE_PRIVATE18',
    'SAFT8kHz16BitStereo', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'ISpObjectTokenCategory', 'DISPID_SOTIsUISupported',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SADefaultFormat', 'SpeechSpecialTransitionType',
    'DISPID_SVStatus', 'SAFTDefault', 'SPEI_UNDEFINED',
    'DISPID_SRCResume', 'ISpeechTextSelectionInformation',
    'ISpeechRecoGrammar', 'DISPID_SpeechLexiconWords',
    'SRSInactiveWithPurge', 'SVF_Stressed', 'DISPID_SRProfile',
    'DISPID_SAFType', 'SPFM_NUM_MODES', 'DISPID_SRGetRecognizers',
    'SPAUDIOBUFFERINFO', 'SPSHT_OTHER', 'SpeechTokenKeyUI', 'SVP_11',
    'SpeechWordPronounceable', 'DISPID_SRAudioInput',
    'DISPID_SPAPhraseInfo', 'SPSHORTCUTTYPE', 'SVSFParseSapi',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SAFTGSM610_44kHzMono',
    'DISPID_SVGetProfiles', 'SPINTERFERENCE', 'SAFTGSM610_22kHzMono',
    'DISPID_SOTGetAttribute', 'SPSSuppressWord',
    'DISPID_SCSBaseStream', 'SpeechTokenContext',
    'SAFTCCITT_uLaw_11kHzMono', 'eLEXTYPE_MORPHOLOGY',
    'ISpeechObjectTokenCategory', 'SPPHRASE', 'SECFIgnoreKanaType',
    'SGDSActiveUserDelimited', 'SpeechRecoEvents',
    'ISpeechPhraseReplacement', 'DISPID_SGRSTPropertyId',
    'DISPID_SVSLastResult', 'SPSModifier',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SPRuleEngineConfidence',
    'SPPS_Interjection', 'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SRSetPropertyNumber', 'SP_VISEME_11',
    'DISPID_SRRRecoContext', 'DISPID_SPPConfidence', 'DISPID_SBSSeek',
    'SPLOADOPTIONS', 'DISPID_SWFEChannels', 'SDTAll',
    'eLEXTYPE_PRIVATE10', 'SVEViseme',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SPINTERFERENCE_NOISE',
    'DISPID_SPRules_NewEnum', 'DISPID_SPRNumberOfElements',
    'SPBO_NONE', 'DISPID_SRCRetainedAudioFormat', 'SPCT_DICTATION',
    'DISPID_SpeechRecoContext', 'SpeechAudioVolume',
    'DISPID_SpeechObjectTokens', 'ISpeechBaseStream',
    'SpSharedRecoContext', 'STCInprocHandler', 'SRCS_Disabled',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SRRDiscardResultInfo', 'SVSFPurgeBeforeSpeak',
    'DISPID_SRGCmdLoadFromMemory', 'SpLexicon', 'DISPID_SRRAudio',
    'SPCS_ENABLED', 'ISpeechRecoResultDispatch',
    'eLEXTYPE_USER_SHORTCUT', 'SREBookmark', 'DISPID_SVVolume',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SVIsUISupported',
    'SFTSREngine', 'eLEXTYPE_PRIVATE2', 'DISPID_SPPs_NewEnum',
    'DISPID_SpeechAudioFormat', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SPIGrammarId', 'SRSActiveAlways', 'SGDSActive',
    'DISPID_SVESentenceBoundary', 'eLEXTYPE_RESERVED4',
    'SP_VISEME_20', 'DISPID_SDKSetBinaryValue', 'DISPID_SPIGetText',
    'SPDKL_LocalMachine', 'SpeechRegistryLocalMachineRoot',
    'SDKLCurrentConfig', 'eLEXTYPE_PRIVATE1',
    'DISPID_SVGetAudioOutputs', 'SASRun',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SLAddPronunciation',
    'SpVoice', 'SPPHRASERULE', 'SPSUnknown', 'SPCS_DISABLED',
    'SpeechStreamFileMode', 'DISPID_SVEWord',
    'DISPID_SpeechGrammarRuleStateTransitions', 'DISPID_SRGRules',
    'DISPID_SRGDictationUnload', 'SPCT_SUB_DICTATION',
    'DISPID_SOTDisplayUI', 'eLEXTYPE_PRIVATE12',
    'DISPID_SRRTTickCount', 'DISPID_SRCVoice', 'SPPS_Unknown',
    'tagSTATSTG', 'SAFT24kHz16BitMono', 'SAFTADPCM_8kHzStereo',
    'SGSEnabled', 'SPWF_SRENGINE', 'DISPID_SRRTLength',
    'DISPID_SGRSTransitions', 'SPBINARYGRAMMAR', 'DISPID_SVPause',
    'SpObjectTokenCategory', 'SpeechPropertyComplexResponseSpeed',
    'DISPID_SOTCId', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SpeechBaseStream', 'SpPhoneConverter',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SRCBookmark',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SPPName',
    'SRESoundStart', 'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SPAs_NewEnum', 'LONG_PTR', 'SAFTGSM610_11kHzMono',
    'SPTEXTSELECTIONINFO', 'SPAR_High', 'DISPID_SLPs_NewEnum',
    'SAFTExtendedAudioFormat', 'DISPID_SpeechPhraseProperty',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SRCCreateGrammar',
    'SAFTCCITT_ALaw_8kHzMono', 'SP_VISEME_19', 'SPEI_RECOGNITION',
    'DISPID_SPAsItem', 'ISpEventSink', 'DISPID_SPRuleFirstElement',
    'DISPID_SpeechAudioStatus', 'STCInprocServer',
    'SpeechCategoryRecognizers', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SOTGetDescription', 'ISpeechRecoResult2',
    'DISPID_SGRSRule', 'SBOPause', 'DISPID_SPAStartElementInResult',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPEI_RESERVED2', 'SPAUDIOOPTIONS', 'SRSActive',
    'DISPID_SABufferInfo', 'SPRECOSTATE', 'DISPID_SRSAudioStatus',
    'SpeechRecoProfileProperties', 'SP_VISEME_4', 'DISPID_SRIsShared',
    'SAFTCCITT_uLaw_22kHzMono', 'SRTSMLTimeout', 'SDTDisplayText',
    'SVSFDefault', 'DISPID_SVSInputSentencePosition', 'SRTEmulated',
    'DISPID_SVGetVoices', 'SINoSignal', 'DISPID_SLGenerationId',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SpeechFileStream',
    'DISPIDSPTSI', 'SPEVENTSOURCEINFO', 'SPPROPERTYINFO',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPSInterjection',
    'SpeechVisemeFeature', 'SPXRO_SML',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SVP_1', 'SPPS_Modifier',
    'SPINTERFERENCE_TOOQUIET', 'SpeechTokenKeyAttributes',
    'SVSFIsNotXML', 'DISPID_SLWType', 'DISPID_SPIEngineId',
    'Speech_StreamPos_Asap', 'SpeechInterference', 'DISPID_SLPsItem',
    'SPEI_START_SR_STREAM', 'ISequentialStream', 'SVP_8',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SASetState',
    'ISpeechLexiconPronunciations', 'DISPID_SDKDeleteValue',
    'DISPID_SGRSTRule', 'DISPID_SRCEFalseRecognition',
    'SpeechRunState', 'SITooSlow', 'DISPID_SPEDisplayAttributes',
    'SDTAlternates', 'SpResourceManager', 'DISPID_SRCERequestUI',
    'SAFTADPCM_11kHzMono', 'SRSInactive', 'SPEI_TTS_BOOKMARK',
    'SPRST_INACTIVE', 'SpMMAudioIn', 'SpPhraseInfoBuilder',
    'DISPID_SVSpeakStream', 'SREAdaptation', 'SGPronounciation',
    'SPRULESTATE', 'ISpeechPhraseProperty',
    'SpeechDictationTopicSpelling', 'ISpeechVoiceStatus',
    'SDKLLocalMachine', 'SVPOver', 'eLEXTYPE_PRIVATE17',
    'SPINTERFERENCE_NOSIGNAL', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SRRSpeakAudio', 'DISPID_SPPParent', 'SPAS_RUN',
    'SPEI_RESERVED1', 'SpeechVoiceEvents', 'eLEXTYPE_PRIVATE20',
    'SPLO_DYNAMIC', 'DISPID_SGRId', 'ISpeechGrammarRules',
    'SPEVENTENUM', 'SREStreamStart', 'SPPS_RESERVED4',
    'DISPID_SpeechLexiconProns', 'SpeechCategoryAppLexicons',
    'SVP_14', 'ISpeechPhraseElements', 'eLEXTYPE_PRIVATE11',
    'SAFTNoAssignedFormat', 'IInternetSecurityManager', 'SPWF_INPUT',
    'SPGRAMMARSTATE', 'SpeechEmulationCompareFlags', 'SVSFIsXML',
    'ISpObjectWithToken', 'ISpNotifySource', 'SPEI_MIN_SR',
    'DISPID_SGRsAdd', '_SPAUDIOSTATE', 'DISPID_SRCEPhraseStart',
    'SGSDisabled', 'DISPID_SPACommit', 'DISPID_SRGDictationSetState',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SRCEStartStream', 'SAFTCCITT_ALaw_11kHzMono',
    'ISpeechGrammarRuleStateTransition', 'SLTApp',
    'DISPID_SDKSetLongValue', 'DISPID_SGRInitialState',
    'DISPIDSPTSI_ActiveOffset', 'eLEXTYPE_RESERVED8',
    'SpInProcRecoContext', 'ISpeechCustomStream',
    'DISPID_SVDisplayUI', 'SRATopLevel', 'DISPID_SVEVoiceChange',
    'SpeechPropertyResourceUsage', 'DISPID_SLWsItem', 'SPAS_PAUSE',
    'DISPID_SVSRunningState', 'ISpeechPhraseRule', 'SDTLexicalForm',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SRGIsPronounceable',
    'SAFT8kHz16BitMono', 'DISPID_SPRulesItem', 'SPEI_RESERVED5',
    'DISPIDSPTSI_SelectionOffset', 'SVP_12', 'SPEI_END_INPUT_STREAM',
    'DISPID_SWFEBitsPerSample', 'SPSEMANTICERRORINFO',
    'SECFIgnoreCase', 'DISPID_SABufferNotifySize',
    'SAFT44kHz8BitMono', 'SP_VISEME_10', 'SpeechDataKeyLocation',
    'DISPID_SRGDictationLoad', 'SGDisplay',
    'SpeechPropertyNormalConfidenceThreshold', 'SGDSInactive',
    'DISPID_SpeechPhraseElement', 'ISpStream', 'SpeechPartOfSpeech',
    'eLEXTYPE_PRIVATE5', 'DISPID_SVEventInterests',
    'SPEI_SOUND_START', 'SVP_9', 'SVP_21',
    'SAFTCCITT_ALaw_8kHzStereo', 'SPFM_OPEN_READONLY',
    'DISPID_SFSOpen', 'SAFT12kHz8BitStereo', 'SAFT24kHz8BitStereo',
    'ISpeechMMSysAudio', 'DISPID_SRCEEnginePrivate', 'ISpMMSysAudio',
    'SDTReplacement', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SPERequiredConfidence', 'SpStream',
    'DISPID_SLGetGenerationChange', 'DISPID_SRSSupportedLanguages',
    'DISPID_SRCRecognizer', 'SpeechAudioFormatType',
    'SpeechGrammarState', 'DISPID_SRRTStreamTime',
    'SSSPTRelativeToCurrentPosition', 'SpeechWordType',
    'DISPID_SPIProperties', 'ISpeechMemoryStream', 'SPEI_REQUEST_UI',
    'DISPID_SMSALineId', 'ISpeechDataKey', 'DISPID_SVVoice',
    'SpTextSelectionInformation', 'DISPID_SpeechCustomStream',
    'SPSHT_NotOverriden', 'ISpeechRecognizer', 'SpNullPhoneConverter',
    'SVP_20', 'SAFT32kHz16BitMono', 'SAFT24kHz16BitStereo',
    'ISpRecoContext2', 'DISPID_SPPValue', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SRCESoundEnd', 'DISPID_SpeechMMSysAudio',
    'SPCATEGORYTYPE', 'SpInprocRecognizer', 'SPSEMANTICFORMAT',
    'DISPID_SVAudioOutputStream', 'DISPID_SLRemovePronunciation',
    'DISPID_SPCPhoneToId', 'STSF_LocalAppData', 'ISpeechGrammarRule',
    'SRTExtendableParse', 'DISPID_SpeechRecognizer', 'SRTReSent',
    'DISPID_SWFEBlockAlign', 'SAFT8kHz8BitStereo', 'eWORDTYPE_ADDED',
    'SpMMAudioOut', 'SpeechPropertyAdaptationOn', 'SVP_5',
    'ISpGrammarBuilder', 'SECFEmulateResult', 'SREHypothesis',
    'STCAll', 'DISPID_SPRuleParent', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SGRSTText', 'ISpRecoGrammar2', 'ISpeechLexicon',
    'SP_VISEME_9', 'DISPID_SOTCEnumerateTokens', 'SRTStandard',
    'SpeechVoicePriority', 'SPEI_FALSE_RECOGNITION',
    'SpeechAudioState', 'DISPID_SASState',
    'SpeechPropertyLowConfidenceThreshold', 'SpStreamFormatConverter',
    'SVEPrivate', 'DISPID_SLGetWords', 'ISpeechLexiconPronunciation',
    'ISpRecoCategory', 'ISpStreamFormat', 'SpeechGrammarWordType',
    'DISPID_SOTCreateInstance', 'SREAudioLevel',
    'DISPID_SPPBRestorePhraseFromMemory', 'SPWT_DISPLAY',
    'DISPID_SPPNumberOfElements', 'SAFT22kHz16BitMono',
    'ISpeechPhraseAlternate', 'SPINTERFERENCE_TOOSLOW',
    'SDA_No_Trailing_Space', 'SPRS_INACTIVE', 'DISPID_SRGId',
    'SPXMLRESULTOPTIONS', 'DISPID_SPIAudioStreamPosition',
    'SRESoundEnd', 'DISPID_SPRs_NewEnum', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SMSSetData', 'SpeechAddRemoveWord', 'SPWORDPRONOUNCEABLE',
    'DISPID_SDKEnumValues', 'SAFT22kHz16BitStereo', 'SGSExclusive',
    'SP_VISEME_5', 'SAFT11kHz16BitMono', 'SAFT22kHz8BitMono',
    'ISpDataKey', 'SRERecognition', 'DISPID_SRCRequestedUIType',
    'SAFTCCITT_ALaw_44kHzStereo', 'SGRSTTDictation',
    'DISPID_SPRuleConfidence', 'DISPID_SABIBufferSize',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SRGSetTextSelection',
    'SGRSTTRule', 'ISpeechGrammarRuleStateTransitions',
    'SpeechCategoryRecoProfiles', 'SpeechCategoryPhoneConverters',
    'DISPID_SpeechRecoResult', 'SAFT44kHz8BitStereo',
    'DISPID_SpeechDataKey', 'SVEAudioLevel',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SRCERecognition',
    'DISPID_SpeechPhraseElements', 'DISPID_SGRSTNextState',
    'DISPID_SPEDisplayText', 'SVSFVoiceMask', 'DISPID_SLPSymbolic',
    'DISPID_SBSWrite', 'SRAExport', 'DISPID_SLPPhoneIds',
    'SAFTNonStandardFormat', 'SGRSTTWildcard', 'DISPID_SRGReset',
    'SAFTText', 'SGDSActiveWithAutoPause',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SGRAttributes', 'SPAR_Low', 'SPAUDIOSTATUS',
    'SPEI_SOUND_END', 'ISpeechPhraseReplacements',
    'DISPID_SRRTOffsetFromStart', 'SpeechLexiconType',
    'SPPS_NotOverriden', 'ISpRecoGrammar', 'DISPID_SVEViseme',
    'DISPID_SOTCSetId', 'DISPID_SVSInputSentenceLength',
    'SDA_Two_Trailing_Spaces', 'SVP_2', 'DISPID_SRCEAdaptation',
    'DISPID_SLPLangId', 'DISPID_SLGetPronunciations',
    'SpeechCategoryAudioOut', 'SAFTCCITT_ALaw_22kHzStereo',
    'SECFIgnoreWidth', 'eLEXTYPE_PRIVATE7', 'SVSFParseMask',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SPRulesCount',
    'DISPID_SRCERecognizerStateChange', 'SPGS_EXCLUSIVE',
    'eLEXTYPE_RESERVED9', 'ISpProperties', 'SpeechCategoryAudioIn',
    'SPSFunction', 'SPSMF_SRGS_SAPIPROPERTIES', 'STSF_CommonAppData',
    'SPAS_STOP', 'SVEPhoneme', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SAFTCCITT_uLaw_44kHzMono',
    'SpeechGrammarRuleStateTransitionType',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'ISpXMLRecoResult',
    'SpeechRecognizerState', 'SPBO_PAUSE', 'DISPID_SGRsCount',
    'SPADAPTATIONRELEVANCE', 'SP_VISEME_6',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SRRGetXMLErrorInfo',
    'SRCS_Enabled', 'SRADynamic', 'SPRECOCONTEXTSTATUS',
    'SPFM_CREATE_ALWAYS', 'DISPID_SGRsCommit',
    'ISpeechPhraseInfoBuilder', 'DISPID_SOTRemoveStorageFileName',
    'DISPID_SVEStreamEnd', 'SVESentenceBoundary',
    'DISPID_SRAudioInputStream', 'DISPID_SPPChildren', 'DISPID_SOTId',
    'DISPID_SRCPause', 'SpMemoryStream', 'SPEI_SR_RETAINEDAUDIO',
    'SPGS_ENABLED', 'SPSNoun', 'DISPID_SGRSTPropertyName',
    'SpeechAudioProperties', 'SSSPTRelativeToStart',
    'DISPID_SGRSAddWordTransition', 'SPEI_MAX_SR', 'DISPID_SLPType',
    'DISPID_SBSFormat', 'eLEXTYPE_RESERVED10', 'ISpNotifyTranslator',
    'SINoise', 'SpeechVoiceSkipTypeSentence', 'SRSEDone',
    'SPFILEMODE', 'SDTPronunciation', 'SPEI_ADAPTATION',
    'DISPID_SWFEAvgBytesPerSec', 'ISpObjectToken',
    'ISpResourceManager', '_ISpeechRecoContextEvents', 'SPEVENT',
    'DISPID_SLWLangId', 'SVP_7', 'DISPID_SPRDisplayAttributes',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SVEBookmark',
    'SAFT44kHz16BitStereo', 'DISPID_SMSADeviceId', 'SRAImport',
    'SAFT11kHz8BitMono', 'SAFT11kHz8BitStereo', 'SPAR_Medium',
    'DISPID_SRGCmdLoadFromObject', 'SLODynamic', 'SPRST_NUM_STATES',
    'SVSFNLPSpeakPunc', 'DISPID_SWFEFormatTag', 'SpeechMicTraining',
    'DISPID_SRCEInterference', 'SGRSTTTextBuffer',
    'SPEI_START_INPUT_STREAM', 'DISPID_SGRSAddRuleTransition',
    'SSFMCreateForWrite', 'SpeechTokenShellFolder',
    'DISPID_SOTCategory', 'DISPID_SGRName', 'SPAUDIOSTATE',
    'SVSFPersistXML', 'DISPID_SPAsCount',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SpeechPhraseBuilder',
    'SRSEIsSpeaking', 'SASPause', 'ISpeechAudioStatus',
    'ISpRecognizer2', 'SAFT48kHz16BitMono', 'ISpeechResourceLoader',
    'SAFT48kHz8BitMono', 'SRAORetainAudio', 'DISPID_SPARecoResult',
    'DISPID_SPILanguageId', 'SpeechFormatType', 'SPPS_Noncontent',
    'ISpeechRecoResult', 'SDKLDefaultLocation',
    'SpeechRecognitionType', 'SPBO_TIME_UNITS', 'DISPID_SpeechVoice',
    'DISPID_SPRsItem', 'SRAONone', 'DISPID_SGRs_NewEnum', 'ISpPhrase',
    'DISPID_SGRAddResource', 'SPGS_DISABLED', 'ISpeechObjectTokens',
    'DISPID_SPEPronunciation', 'SpeechStreamSeekPositionType',
    'DISPID_SVWaitUntilDone', 'DISPID_SRIsUISupported',
    'ISpRecognizer', 'DISPID_SPRuleChildren', 'DISPID_SLWsCount',
    'DISPID_SRCSetAdaptationData', 'SAFTADPCM_22kHzStereo',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SRCState',
    'SPPS_RESERVED1', 'SAFT32kHz16BitStereo', 'SPEI_WORD_BOUNDARY',
    'SPINTERFERENCE_TOOLOUD', 'SWTAdded',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SPIRule',
    'SpeechPropertyResponseSpeed', 'SPPHRASEREPLACEMENT',
    'DISPID_SRSNumberOfActiveRules', 'SVSFUnusedFlags',
    'DISPID_SRGCmdLoadFromFile', 'SASStop', 'SDTAudio',
    'SPSNotOverriden', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SRSCurrentStreamNumber', 'ISpAudio',
    'SpeechBookmarkOptions', 'DISPID_SpeechLexiconPronunciation',
    'SPDKL_CurrentConfig', 'SPRECOGNIZERSTATUS', 'SLTUser',
    'SAFT16kHz8BitMono', 'DISPID_SpeechWaveFormatEx',
    'SpWaveFormatEx', 'SPWORDPRONUNCIATIONLIST',
    'SECNormalConfidence', 'SPPS_Noun', 'ISpeechRecognizerStatus',
    'DISPID_SPEsCount', 'DISPID_SPELexicalForm', 'SAFT24kHz8BitMono',
    'ISpStreamFormatConverter', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SABIMinNotification', 'SECFDefault', 'DISPID_SOTSetId',
    'DISPID_SOTMatchesAttributes', 'SPPARTOFSPEECH',
    'DISPID_SOTsCount', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'eLEXTYPE_PRIVATE15',
    'DISPID_SPIAudioSizeBytes', 'SpeechVoiceSpeakFlags', 'SLOStatic',
    'DISPID_SOTsItem', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SRGetFormat', 'SpAudioFormat', 'IEnumString',
    'DISPID_SVGetAudioInputs', 'ISpRecognizer3',
    'DISPID_SpeechPhraseRule', 'SP_VISEME_3', 'DISPID_SRCEEndStream',
    'SAFTCCITT_uLaw_44kHzStereo', 'ISpeechAudioFormat',
    'SRTAutopause', 'DISPID_SpeechGrammarRule', 'SPEI_RESERVED6',
    'SPAO_RETAIN_AUDIO', 'SDTProperty', 'DISPID_SVSkip',
    'SpUnCompressedLexicon', 'ISpShortcut', 'ISpSerializeState',
    'Speech_Default_Weight', 'DISPID_SDKGetlongValue', 'SVP_6',
    'SAFT22kHz8BitStereo', 'SVP_0', 'DISPIDSPTSI_ActiveLength',
    'SRARoot', 'SP_VISEME_13', 'SAFT12kHz16BitStereo',
    'SREFalseRecognition', 'SAFT16kHz8BitStereo', 'DISPID_SPRuleName',
    'SAFTADPCM_11kHzStereo', 'ISpPhoneticAlphabetSelection',
    'DISPID_SPIReplacements', 'SAFT16kHz16BitMono',
    'DISPID_SDKDeleteKey', 'eLEXTYPE_APP', 'SPEI_SR_BOOKMARK',
    'DISPID_SRRecognizer', 'SpCompressedLexicon',
    'DISPID_SRCreateRecoContext', 'DISPID_SPIAudioSizeTime',
    'SPEI_MAX_TTS', 'DISPID_SRRAudioFormat', 'SPPS_RESERVED2',
    'DISPID_SRCESoundStart', 'SVP_13', 'DISPID_SGRsItem',
    'SREPrivate', 'SPPS_LMA', 'SGRSTTWord', 'DISPID_SBSRead',
    'tagSPPROPERTYINFO', 'SVP_15', 'SpObjectToken', 'SGRSTTEpsilon',
    'DISPID_SRCEPropertyStringChange', 'SPDKL_DefaultLocation',
    'ISpPhoneticAlphabetConverter', 'DISPID_SVResume', 'SVP_19',
    'SWPKnownWordPronounceable', 'DISPID_SPEEngineConfidence',
    'DISPID_SRGetPropertyString', 'SPINTERFERENCE_TOOFAST',
    'eLEXTYPE_USER', 'DISPID_SVSPhonemeId', 'SAFT48kHz8BitStereo',
    'SAFTADPCM_44kHzStereo', 'DISPID_SRRAlternates', 'SPLEXICONTYPE',
    'SpSharedRecognizer', 'DISPID_SLPPartOfSpeech',
    'DISPID_SPIEnginePrivateData', 'DISPID_SpeechPhraseReplacements',
    'DISPID_SPRsCount', 'SVEStartInputStream',
    'DISPID_SVSInputWordLength', 'SDTRule', 'SPBOOKMARKOPTIONS',
    'DISPID_SRCEHypothesis', 'ISpeechPhraseElement',
    'DISPID_SWFESamplesPerSec', 'SAFT48kHz16BitStereo',
    'ISpPhoneConverter', 'DISPID_SRGRecoContext',
    'DISPID_SPIElements', 'SSTTDictation', 'DISPID_SOTs_NewEnum',
    'SREStateChange', 'DISPID_SDKOpenKey', 'SPGRAMMARWORDTYPE',
    'DISPID_SAFGuid', 'ISpeechWaveFormatEx', 'DISPID_SPPsCount',
    'SpeechGrammarTagWildcard', 'DISPID_SREmulateRecognition'
]

_check_version('1.1.13', 1652592903.043828)
